    ...
    class StageSuperMario extends Phaser.Scene {
        ...
        create() {
            ...
            this.bgm.play();
             ...
             // 맵 크기 정보 설정
            let imageWidth = this.game.imageWidth;
            let imageHeight = this.game.imageHeight;

            // MasterController 초기화 시 맵 크기 정보 전달
            ...
            this.load.once('complete', () => {
                ...
                this.masterController = new MasterController(this, this.bgm);
                this.masterController.init(this.characterName, {
                    width: this.game.imageWidth,
                    height: this.game.imageHeight
                });
